    ...
    <div className="flex h-screen bg-gray-100">
      ...
      >
        ...
        <nav className="mt-6">
          <Link
            to="/admin/dashboard"
            className="flex items-center p-3 hover:bg-indigo-700"
          >
            <svg
              className="w-6 h-6"
              fill="none"
          ...
          >
            ...
            {sidebarOpen && <span className="ml-3">Coaches</span>}
          </Link>
          ...
          >
            ...
            {sidebarOpen && <span className="ml-3">Salary</span>}
          </Link>

          <div className="absolute bottom-0 left-0 right-0 p-4">
            <button
              onClick={handleLogout}
              className="flex items-center p-3 text-red-300 hover:bg-indigo-700 rounded"
            >
              <svg
                className="w-6 h-6"
                fill="none"
